...
//    }
    ...
    public Bet prepareBet(Bet bet, Pool pool){
        Set<Number> betNumbers = numberService.insertNumbersInBet(bet, pool);
        ...
        numberService.insertAll(betNumbers);
    ...
    public int countMatched(Bet bet){
        return betRepository.countMatchedNumbersByBet(bet.getId());
    }
    ...
    public void delete(String id){
        ...
        betRepository.delete(bet.getId().toString());
    }
